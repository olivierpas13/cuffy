import { formatAsCurrency, sendBuyMessage, getColorBasedOnStatus } from "@/utils/productsUtils";
...
const ProductInfo = ({ product }) => {
  return (
    <div className="basis-3/6 mt-6 lg:mt-0 lg:p-8 flex flex-col my-auto">
      ...
      <span
        className={`inline-block w-fit px-2 py-1 my-4 rounded-md text-sm font-medium ${getColorBasedOnStatus(product.status)}`}
      >
        {product.status}
      </span>
      <p>
